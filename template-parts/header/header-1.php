...
$harry_header_phone = get_theme_mod('harry_phone', '+8983 38329');
$harry_header_timing = get_theme_mod('harry_timing', 'Sunday-Thurs 10am-07pm');
?>
                        ...
                        <div class="header__info">
                            <ul>
                                <?php if (!empty($harry_header_email)) : ?>
                                    <li>
                                        <a href="mailto:<?php echo esc_html($harry_header_email) ?>">
                                            <span>
                                ...
                                <?php if (!empty($harry_header_phone)) : ?>
                                    <li>
                                        <a href=" <?php echo esc_html($harry_header_phone) ?>">
                                            <span>
                                ...
                                <?php endif; ?>
                                <?php if (!empty($harry_header_timing)) : ?>
                                    <li>
                                        <span>
                                            <span>
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
